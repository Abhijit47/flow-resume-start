...
export default function OrganisationsContent() {
  ...
  const {
    organisationsOpts: { fields, append },
          ...
          >
            <CardHeader>
              <div className="flex items-center justify-between">
                <h4 className="text-sm font-semibold">Organisation</h4>
...
export function OrganisationDeleteButton() {
  const [isAccepted, setIsAccepted] = useState(false)
  const [isOpen, setIsOpen] = useState(false)

  const {
    organisationsOpts: { fields, remove },
  } = useResumeFormContext()
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className={'mx-auto sm:max-w-md'}>
        <DialogHeader>
          <DialogTitle>Delete “Award” section?</DialogTitle>
          <DialogDescription>
