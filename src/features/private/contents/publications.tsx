...
import PublicationForm from './forms/publication-form'

export default function PublicationsContent() {
  const [isOpen, setIsOpen] = useState(false)

  const {
    publicationsOpts: { fields, append },
          ...
          >
            <CardHeader>
              <div className="flex items-center justify-between">
                <h4 className="text-sm font-semibold">Publication</h4>
...
export function PublicationDeleteButton() {
  ...
  const {
    publicationsOpts: { fields, remove },
  } = useResumeFormContext()
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className={'mx-auto sm:max-w-md'}>
        <DialogHeader>
          <DialogTitle>Delete “Publication” section?</DialogTitle>
          <DialogDescription>
