    ...
    <FieldGroup>
      <FieldSet>
        <div className={'flex items-center justify-between'}>
          ...
          <FormItemSettings tipItemName="education" />
        </div>
        <FieldSet>
          <Field>
            <FieldLabel htmlFor="education-degree">Degree</FieldLabel>
            <Input
              id="education-degree"
          ...
          <Field>
            <FieldLabel htmlFor="education-school">School</FieldLabel>
            <InputGroup>
              <InputGroupInput
                id="education-school"
                placeholder="Enter School / University / Institution"
              />
              <InputGroupAddon align="inline-end">
                <Popover open={isOpen} onOpenChange={setIsOpen}>
                  ...
                  <PopoverContent align="end" className="w-72">
                    <Field>
                      <FieldLabel htmlFor="education-link-url">
                        Link URL
                      </FieldLabel>
                      <InputGroup>
                        <InputGroupInput
                          id="education-link-url"
          ...
          <div className={'grid grid-cols-1 md:grid-cols-3 gap-4'}>
            ...
            <Field>
              <FieldLabel htmlFor="education-location">Location</FieldLabel>
              <Input id="education-location" placeholder="City, Country" />
            </Field>
          </div>

          <Field>
            <FieldLabel htmlFor="education-description">Description</FieldLabel>
            <Textarea
