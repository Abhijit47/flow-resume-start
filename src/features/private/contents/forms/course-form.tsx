    ...
    <FieldGroup>
      <FieldSet>
        <div className={'flex items-center justify-between'}>
          ...
          <FormItemSettings tipItemName="courses" />
        </div>
        <FieldSet>
          <Field>
              ...
              <InputGroupAddon align="inline-end">
                <Popover open={isOpen} onOpenChange={setIsOpen}>
                  ...
                  <PopoverContent align="end" className="w-72">
                    <Field>
                      <FieldLabel htmlFor="course-link-url">
                        Link URL
                      </FieldLabel>
                      <InputGroup>
                        <InputGroupInput
          ...
          <Field>
            <FieldLabel htmlFor="course-institution">Institution</FieldLabel>
            <Input id="course-institution" placeholder="Enter institution" />
          </Field>

          <div className={'grid grid-cols-1 md:grid-cols-3 gap-4'}>
            <Field>
              <FieldLabel htmlFor="course-start-date">Start Date</FieldLabel>
              <Popover>
                <PopoverTrigger asChild id="course-start-date">
            ...
            <Field>
              <FieldLabel htmlFor="course-end-date">End Date</FieldLabel>
              <Popover>
                <PopoverTrigger asChild id="course-end-date">
                  <Button variant="outline" type="button">
                    {endDate
                ...
                <PopoverContent className="w-full">
                  <Field orientation="horizontal" className="w-fit">
                    <FieldLabel htmlFor="course-present-switch">
                      Present
                    </FieldLabel>
                    <Switch
                      id="course-present-switch"
                      checked={isPresent}
            ...
            <Field>
              <FieldLabel htmlFor="course-location">Location</FieldLabel>
              <Input id="course-location" placeholder="City, Country" />
            </Field>
          </div>
