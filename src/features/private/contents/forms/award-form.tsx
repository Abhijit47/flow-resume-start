    ...
    <FieldGroup>
      <FieldSet>
        <div className={'flex items-center justify-between'}>
          ...
          <FormItemSettings tipItemName="awards" />
        </div>
        <FieldSet>
          <Field>
            <FieldLabel htmlFor="award-name">Award</FieldLabel>
            <InputGroup>
              <InputGroupInput id="award-name" placeholder="Enter award" />
              <InputGroupAddon align="inline-end">
                <Popover open={isOpen} onOpenChange={setIsOpen}>
                  ...
                  <PopoverContent align="end" className="w-72">
                    <Field>
                      <FieldLabel htmlFor="award-link-url">Link URL</FieldLabel>
                      <InputGroup>
                        <InputGroupInput
                          id="award-link-url"
          ...
          <Field>
            <FieldLabel htmlFor="award-issuer-name">Issuer</FieldLabel>
            <Input id="award-issuer-name" placeholder="Enter issuer" />
          </Field>
          ...
          <FieldGroup className={'gap-2'}>
            ...
            <div className={'grid grid-cols-1 md:grid-cols-3 gap-4'}>
              <FieldGroup className={'gap-2'}>
                {isShowDay ? (
                  <Field>
                    <FieldLabel htmlFor="award-date-day" className={'sr-only'}>
                      Day
                    </FieldLabel>
                    <Select>
                      <SelectTrigger id="award-date-day">
                ...
                <Field orientation="horizontal">
                  <Checkbox
                    id="award-day-dont-show-checkbox"
                    checked={!isShowDay}
                    onCheckedChange={(checked) => setIsShowDay(!checked)}
                  />
                  <FieldLabel
                    htmlFor="award-day-dont-show-checkbox"
              ...
              <FieldGroup className={'gap-2'}>
                ...
                <Field orientation="horizontal">
                  <Checkbox
                    id="award-month-dont-show-checkbox"
                    checked={!isShowMonth}
                    onCheckedChange={(checked) => setIsShowMonth(!checked)}
                  />
                  <FieldLabel
                    htmlFor="award-month-dont-show-checkbox"
                    className="font-normal"
                  >
                    Don't show
                  </FieldLabel>
              ...
              <Field>
                <FieldLabel htmlFor="award-date-year" className={'sr-only'}>
                  Year
                </FieldLabel>
                <Select>
                  <SelectTrigger>
          ...
          <Field>
            ...
            <Textarea
              ...
              placeholder="Description your award..."
