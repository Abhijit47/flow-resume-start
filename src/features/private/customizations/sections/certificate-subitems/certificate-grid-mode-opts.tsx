...
/*
grid mode:
{"customizationUpdates":[{"value":"one","path":"certificateDisplay.grid.columns"}]}
{"customizationUpdates":[{"value":"two","path":"certificateDisplay.grid.columns"}]}
{"customizationUpdates":[{"value":"three","path":"certificateDisplay.grid.columns"}]}
{"customizationUpdates":[{"value":"four","path":"certificateDisplay.grid.columns"}]}
*/
...
export default function CertificateGridModeOpts() {
  const {
    customization: { certificateDisplay },
    updateCertificateDisplay,
  } = useCustomizationStore()

  const isGridMode = certificateDisplay.selected === 'grid'

  const currentGridModeCols = certificateDisplay.grid.columns
