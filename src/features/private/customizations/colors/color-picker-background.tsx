...
export default function ColorPickerBackground() {
  ...
  const colorPicker = useColorPicker({
    id: id,
    defaultValue: parseColor(colors.basic.multiCustom.backgroundColor),
    closeOnSelect: true,
    onValueChange(event) {
      ...
      // criteria:
      // colors.basic.multi.backgroundColor = newValue
      // colors.basic.multiCustom.backgroundColor = newValue
      updateColors({
        basic: {
          ...colors.basic,
          multi: {
