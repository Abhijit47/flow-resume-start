...
export default function ColorPickerAccent() {
  ...
  const colorPicker = useColorPicker({
    id: id,
    defaultValue: parseColor(colors.basic.multiCustom.accentColor),
    closeOnSelect: true,
    onValueChange(event) {
      ...
      // criteria:
      // colors.basic.multiCustom.accentColor = newValue
      // colors.basic.multiCustom.accentColor = newValue
      updateColors({
        basic: {
          ...colors.basic,
  ...
  return (
    <ColorPicker.RootProvider className={'h-fit max-w-100'} value={colorPicker}>
      <ColorPicker.Label className={'sr-only'}>Accent Color</ColorPicker.Label>
