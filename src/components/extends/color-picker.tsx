...
export const ColorPickerSelection = memo(
  ({ className, ...props }: ColorPickerSelectionProps) => {
    ...
    return (
      <div
        className={cn(
          'relative h-48 w-full cursor-crosshair rounded',
          className,
        )}
        onPointerDown={(e) => {
          e.preventDefault()
      ...
      >
        <div
          className="-translate-x-1/2 -translate-y-1/2 pointer-events-none absolute h-4 w-4 rounded-full border-2 border-border"
          style={{
            left: `${positionX * 100}%`,
            top: `${positionY * 100}%`,
...
export const ColorPickerHue = ({
  ...
  return (
    <Slider.Root
      ...
      max={360}
      onValueChange={([hueVal]) => setHue(hueVal)}
      step={1}
      value={[hue]}
      {...props}
    >
...
export const ColorPickerAlpha = ({
  ...
  return (
    <Slider.Root
      className={cn('relative flex h-4 w-full touch-none', className)}
      max={100}
      onValueChange={([alphaVal]) => setAlpha(alphaVal)}
      step={1}
      value={[alpha]}
      {...props}
    >
